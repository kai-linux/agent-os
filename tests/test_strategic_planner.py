...
def test_build_plan_prompt_includes_research_context():
    prompt = _build_plan_prompt(
        ...
        recent_architectural_decisions="(none)",
...
def test_build_plan_prompt_includes_recent_architectural_decisions():
    prompt = _build_plan_prompt(
        plan_size=3,
        strategy_context="strategy",
        readme_goal="goal",
        ...
        evaluation_rubric="",
        codebase_context="codebase",
        recent_architectural_decisions="- 2026-04-21 — ADR 0003: Adopt event schema",
        production_feedback_context="signals",
        product_inspection_context="(product inspection disabled)",
        outcome_context="outcomes",
        research_context="research",
    ...
    assert "--- Recent Architectural Decisions ---" in prompt
    assert "ADR 0003: Adopt event schema" in prompt
