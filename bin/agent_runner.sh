...
CODEX_BIN="/home/kai/.nvm/versions/node/v24.13.0/bin/codex"
CLAUDE_BIN="/home/kai/.nvm/versions/node/v24.13.0/bin/claude"
DEEPSEEK_RUNNER="${DEEPSEEK_RUNNER:-/opt/agent-orchestrator/bin/run_deepseek.sh}"
